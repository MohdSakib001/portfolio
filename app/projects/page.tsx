...
export const metadata: Metadata = {
  ...
  description:
    "8 live production systems spanning FinTech, EdTech, LegalTech, Gaming, and AI. Architected and shipped by Mohd Sakib, Senior Full Stack & React Native Developer. 25K+ users. $100K+ GMV. 98 Lighthouse.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "FinTech · EdTech · LegalTech · Gaming · AI. Every system shipped, scaled, and measured. StakeClash, Artificial Mufti, Pademi, Sendora, CoLaw, Tekish, Teppe.",
    type: "website",
  ...
  twitter: {
    title: "Projects — 8 Live Products | Mohd Sakib",
    description:
      "FinTech · EdTech · LegalTech · Gaming · AI. Every system shipped, scaled, and measured.",
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white selection:bg-[#00ff9d] selection:text-black font-sans">
      ...
      <section className="pt-40 pb-20 px-8 md:px-16 max-w-360 mx-auto">
        <Link
          href="/"
          className="inline-flex items-center gap-3 text-xs uppercase tracking-[0.2em] text-neutral-400 hover:text-white transition-colors duration-300 mb-16 group"
        >
