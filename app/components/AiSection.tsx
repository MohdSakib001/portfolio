    ...
    return (
        <section ref={sectionRef} className="bg-[#050505] text-white overflow-hidden border-t border-white/10">
            ...
            <div className="px-6 md:px-16 pt-24 pb-16 lg:pt-32 lg:pb-16 max-w-4xl">
                <h2 className="text-heading tracking-tighter mb-8 ai-reveal font-semibold">
                    AI Systems & <br />
                    <span className="text-white/40">Orchestration</span>
                </h2>
                <p className="text-body opacity-70 leading-relaxed ai-reveal max-w-2xl font-light">
                    ...
                    {workflows.map((wf, i) => (
                        ...
                        >
                            ...
                            <div className="w-full lg:w-1/3 shrink-0">
                                <div className="text-label font-mono text-white/40 mb-4 pb-4 border-b border-white/10">
                                    0{i + 1} // ARCHITECTURE
                                </div>
                                <h3 className="text-title font-medium tracking-tight mb-4">
                                    {wf.title}
                                </h3>
                                <p className="text-caption text-white/60 font-light leading-relaxed mb-8">
                                    {wf.desc}
                                </p>
